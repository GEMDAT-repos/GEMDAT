...
def plots_from_displacement(sim_data, sites, resolution):
    ...
    ax.set(title='Displacement of diffusing element', xlabel='Time step', ylabel='Displacement (Angstrom)')
    ...
    ax.set(title='Histogram of displacement of diffusing element', xlabel='Displacement (Angstrom)', ylabel='Nr. of atoms')
    ...
    for i in range(sim_data.nr_elements):
        ...
        ax.plot(disp_elem[i,:])
    ax.set(title='Displacement per element', xlabel='Time step', ylabel='Displacement (Angstrom)')

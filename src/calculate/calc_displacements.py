...
def calculate_cell_offsets(trajectory_coords) -> np.ndarray:
...
def calculate_displacements(trajectory_coords,
                            lattice,
    ...
    """
    offsets = calculate_cell_offsets_from_coords(trajectory_coords)
